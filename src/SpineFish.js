...
export default class SpineFish {
  constructor(W, H) {
    this.variety = VARIETIES[Math.floor(Math.random() * VARIETIES.length)];
    this.mass = 420 + Math.random() * 520;
  ...
  update(W, H, cur, env) {
    ...
    // ── Cursor flee: pick a target opposite to the cursor and fully energise
    if (cur && cur.x > -1000) {
